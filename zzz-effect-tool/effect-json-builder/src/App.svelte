<script lang="ts">
  ...
  function handleExport(type: "library" | "discSets" | "characters" | "wengines" | "bundle") {
    switch (type) {
      case "library":
        exportEffectLibrary(store.state.effectLibrary);
        break;
      case "discSets":
        exportDiscSets(store.state.discSets);
        break;
      case "characters":
        exportCharacters(store.state.characters);
        break;
      case "wengines":
        exportWEngines(store.state.wengines);
        break;
      case "bundle":
        exportBundle(
...
<div class="app-shell">
  ...
  <header class="app-header">
    ...
    <div class="header-right">
      ...
      />
      <button class="header-btn" onclick={triggerImport}>📥 Import</button>
